export default function WorkersPage({ showWorkerForm, setShowWorkerForm, newWorker, setNewWorker, handleCreateWorker, workers, ZONES, getZoneMeta, WORKER_STATUS_LABELS, handleUpdateWorkerStatus, handleDeleteWorker }) {
    return (
